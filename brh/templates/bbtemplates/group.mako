<script type='unknown' id='group-view-template'>
  ...
  <ol>
    <li>
     <span> To view theirs as a photo gallery and add yoiur own, head over to:</span>
     ...
     <span> We use pictobin<a href="/faq">?</a> to gather photos and then collect them here to build the molehill.
      ...
      Then check out your grouyp's pictures in the <a href="molehill">the molehill</a>
    </li><li>
      Add a bit of info to help molehill sort everyone's pictures by heading over to <a href="annotationkit">the Annotation Toolkit</a>
	...
	<a href="/faq/building">How we're combining user input, picture metadata and machine learning to build the the molehill</a></div>
      ...
      Sign up to be <a href="notifyme">notified</a> occasionally as molehill undergoes big changes.
